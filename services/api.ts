...
export interface ChargerUsageResponse {
...
export async function fetchChargerUsage(page = 0, size = 5): Promise<ChargerUsageResponse> {
  return await apiRequest<ChargerUsageResponse>(`/dashboard/chargers/usage?page=${page}&size=${size}`)
}
